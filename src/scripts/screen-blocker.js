...
function replaceScreen(reason, quote) {
    ...
    <div id="content-block">
        <style>
            ...
            #content-block section figure blockquote {
                margin: 0;
            }
            ...
            #content-block section figure figcaption {
              font-weight: bolder;
              font-size:  1.5rem;
            }
            ...
            #content-block section figure blockquote::before {
                content: '"';
            }

            #content-block section figure blockquote::after {
                content: '"';
            }
        </style>
        <div>
    ...
    `.replace('{{reason}}', reason)
     .replace('{{quote}}', quote?.quote || 'Everyone is improving and working on themselves while you\'re not. Think about that.')
     .replace('{{author}}', quote?.author || 'Felix Isaac Lim');
